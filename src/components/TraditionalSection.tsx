      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-secondary font-semibold text-sm uppercase tracking-wider font-body">Heritage</span>
          </div>
          ...
          {dishes.map((dish, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <span className="text-primary font-medium text-sm font-body">{dish.subtitle}</span>
                ...
                <Link
                  to={`/recipe/${dish.slug}`}
                  className="font-medium text-primary hover:text-primary/80 transition-colors underline underline-offset-4 font-body"
                >
                  View Full Recipe →
                </Link>
              </div>
