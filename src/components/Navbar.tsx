      ...
      >
        <div className="container mx-auto flex items-center justify-between px-4 lg:px-8">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-primary" onClick={toggleLang}>
          ...
          {mobileOpen && (
            ...
            >
              <div className="flex flex-col p-6 gap-4">
                ...
                <button onClick={() => setSearchOpen(true)} className="text-sm text-primary font-body flex items-center gap-1">
                  <Search className="h-4 w-4" /> {lang === "en" ? "Search Recipes" : "ምግቦችን ፈልግ"}
                </button>
                <button onClick={toggleLang} className="text-sm text-primary font-body flex items-center gap-1">
