    ...
    >
      <Link to={`/recipe/${slug}`}>
        ...
        <div className="relative h-56 overflow-hidden">
          ...
          {/* Category Badge */}
          <span className="absolute top-3 left-3 px-3 py-1 rounded-full text-xs font-semibold bg-cream/90 backdrop-blur-sm text-foreground font-body">
            {category}
          </span>
        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className={`flex items-center gap-1 text-xs font-medium px-2 py-0.5 rounded-full font-body ${difficultyColor[difficulty]}`}>
